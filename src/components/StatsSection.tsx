      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 text-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 -translate-y-1/2 translate-x-1/2 rotate-45"></div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 text-center transform md:scale-110 md:-translate-y-2 z-10">
            ...
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-green-600 text-white text-xs px-3 py-1 rounded-full uppercase font-bold tracking-wider">
              Najvišja ocena
            </div>
          </div>
          
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 w-16 h-16 bg-gradient-to-bl from-green-500 to-green-600 -translate-y-1/2 -translate-x-1/2 rotate-45"></div>
            <div className="text-5xl font-bold text-green-600 mb-2">83%</div>
