        ...
        <div className={cn("flex flex-col items-center gap-12", reverse ? "lg:flex-row-reverse" : "lg:flex-row")}>
          <div className="flex-1">
            ...
            featured ? "aspect-auto" : "aspect-[3/4]", imageClassName)} />
              ...
              {instagramHandle && <div className="text-center mt-2">
                  <a href={`https://instagram.com/${instagramHandle}`} target="_blank" rel="noopener noreferrer" className="text-sm text-tarsal-accent hover:underline inline-flex items-center">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {credentials.length > 0 && <div className="flex flex-wrap gap-2 mb-6 justify-center lg:justify-start">
                {credentials.map((credential, index) => <Badge key={index} variant="outline" className="bg-gray-50">
                    {credential}
                  </Badge>)}
              </div>}
            ...
            {featured && <div className="p-4 rounded-lg border border-gray-100 bg-rose-400">
