  ...
  return <section className="pt-24 md:pt-32 pb-16 md:pb-24 bg-gradient-to-b from-white to-tarsal-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl font-bold mb-8 text-tarsal-accent animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
            "Samo pol ure na dan za dolgotrajno izboljšanje zdravja vaših stopal!"
          </p>
          
          {/* First button - new button added above */}
          <a href="#product" className={cn(
            "inline-flex items-center justify-center",
            "bg-white text-tarsal-accent border-2 border-tarsal-accent rounded-full px-6 py-2 mb-4",
            "hover:bg-tarsal-accent/10 transition-colors",
